...
class Calendar():
    ...
    def test(self):
        ...
        rovinieta = driver.find_element(By.XPATH,"/html//div[@id='__next']//div[5]/div/div[3]/div[.='adaugă alertă']")
        rovinieta.click()
        time.sleep(1)
        ...
        if luna_5 == luna_calendar:
            data_rovinieta = driver.find_element(By.XPATH, "/html//div[@id='choice-calendar']//div[.='" + str(ziua_5_ziua) + "']")
        ...
        #RCA
        rca=driver.find_element(By.XPATH,"/html//div[@id='__next']//div[7]/div/div[3]/div[.='adaugă alertă']")
        rca.click()
        time.sleep(2)
        ...
        if luna_15==luna_calendar:
            data_rca = driver.find_element(By.XPATH,"/html//div[@id='choice-calendar']//div[.='" + str(ziua_15_ziua) + "']")
            data_rca.click()
            time.sleep(1)
